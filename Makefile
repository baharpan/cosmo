...
BOOST_PATH=/ufrc/boucher/baharpan/Vari/boost_1_63_0
DEP_PATH=3rd_party_inst
INC_PATH=-isystem $(DEP_PATH)/include -isystem $(BOOST_PATH)
...
BINARIES=cosmo-pack matrix fast_matrix reduce_color fast_reduce_color bubbles cosmo-build cosmo-color cosmo-benchmark pack-color #match-color # cosmo-assemble
