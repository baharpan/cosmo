...
mkdir -p kmc_temp
ls -1 --color=no *.fastq |xargs -l -i echo "/ufrc/boucher/baharpan/cosmo/3rd_party_src/KMC/bin/kmc -b -fq -ci$c -k32 -cs250 {} {}.kmc kmc_temp" >kmercount.sh
source kmercount.sh
ls -1 --color=no *.fastq |xargs -l -i echo "/ufrc/boucher/baharpan/cosmo/3rd_party_src/KMC/bin/kmc_tools sort {}.kmc {}.kmc.sorted " >kmercountsort.sh
